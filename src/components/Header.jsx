...
import { useAuth } from '@hooks/useAuth'; // Me va permitir acceder al usuario que está logueado
...
export default function Header() {
  const auth = useAuth();
  const userData = {
    name: auth?.user?.name, // (?) Si el usuario está logueado, entonces obtengo su nombre, caso contrario obtengo un string vacío
    email: auth?.user?.email, // (?) Si el usuario está logueado, entonces obtengo su email, caso contrario obtengo un string vacío
    imageUrl: `https://ui-avatars.com/api/?name=${auth?.user?.name}`, // (?) Si el usuario está logueado, entonces obtengo su imagen, caso contrario obtengo un string vacío
  };
